...
class Settings(BaseSettings):
    ...
    # Dashboard (LAN web GUI). The token gates every mutating endpoint (pause/kill/
    # blocklist/settings); blank means the dashboard is read-only. Generated by the
    # Pi installer; lives in .env with the other secrets (mode 600).
